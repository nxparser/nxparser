...
// There is a small patch by Tobias Käfer
//
...
//		System.err.println("%% Attribute value [" + value + "]");
		...
		// Reporting XML namespace definitions to the content handler
		if (theAttributeName.startsWith("xmlns:")) {
			String prefix = theAttributeName.substring("xmlns:".length());
			theContentHandler.startPrefixMapping(prefix, value);
		}
