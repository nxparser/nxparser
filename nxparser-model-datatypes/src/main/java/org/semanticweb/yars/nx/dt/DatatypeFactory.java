...
public class DatatypeFactory {
	 ...
	 *
	 * @return datatype value or null if (i) unsupported datatype; (ii) plain
	 *         literal (w/wo/ lang tag)
	 * @throws DatatypeParseException
	 *             if supported datatype with bad syntax
	 */
	public static Datatype<? extends Object> getDatatype(Literal l)
			throws DatatypeParseException, ParseException {
		return getDatatype(l.toString(), l.getDatatype());
	}

	/**
	 * Get object representing datatype-value of lexical string/datatype URI
	 * pair.
	 *
	 * @return datatype value or null if (i) unsupported datatype; (ii) lex is
	 *         null or dt is null
	 * @throws DatatypeParseException
	 *             if supported datatype with bad syntax
	 */
	public static Datatype<? extends Object> getDatatype(String lex, Resource dt)
			throws DatatypeParseException {
		if (dt == null || lex == null)
			return null;
